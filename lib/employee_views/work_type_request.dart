                        ...
                        children: [
                          ...
                          TypeAheadField<String>(
                            textFieldConfiguration: TextFieldConfiguration(
                              ...
                              decoration: InputDecoration(
                                hintText: 'Search Requesting Work Type',
                                labelStyle: TextStyle(color: Colors.grey[350]),
                                border: const OutlineInputBorder(),
                                contentPadding: const EdgeInsets.symmetric(
                                    horizontal: 10.0),
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Flexible(
                            child: Text('${record['work_type_name'] ?? 'None'}',
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Flexible(
                            child: Text('${record['requested_date'] ?? 'None'}',
                                overflow: TextOverflow.ellipsis,
                                maxLines: 1,
                                textAlign: TextAlign.end,
                                style: TextStyle(fontWeight: FontWeight.w500)),
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Flexible(
                            child: Text('${record['requested_till'] ?? 'None'}',
                                overflow: TextOverflow.ellipsis,
                                maxLines: 1,
                                textAlign: TextAlign.end,
                                style: TextStyle(fontWeight: FontWeight.w500)),
                        ...
                        children: [
                          if (employeeDetails['employee_profile'] != null &&
                            ...
                            Positioned.fill(
                              child: ClipOval(
                                child: Image.network(
                                  baseUrl + employeeDetails['employee_profile'],
                                  fit: BoxFit.cover,
                                  errorBuilder: (BuildContext context,
                                      Object exception,
                                      StackTrace? stackTrace) {
