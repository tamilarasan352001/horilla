...
class _HomePageState extends State<HomePage> {
          ...
          children: [
           ...
           const SizedBox(height: 10.0),
            Card(
              ...
              child: ListTile(
                leading: SvgPicture.asset(Appimages.employeesIcon),
                ...
                trailing: SvgPicture.asset(Appimages.rightArrow),
                onTap: () {
  ...
  appbarwidget() {
    return Column(
      children: [
        // Custom AppBar with decorative circles
        Stack(
          children: [
            Container(
              height: 137,
                ...
                children: [
                  Column(
                    ...
                    children: [
                      ...
                      Text(
                        userName,
                        // arguments['employee_name']?.toString() ?? '',
                  ...
                  Row(
                    children: [
                      ...
                      InkWell(
                          ...
                          child: SvgPicture.asset(notificationsCount > 0
                              ? Appimages.notificationEnable
