          ...
          children: [
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        enabledBorder: OutlineInputBorder(
                          ...
                          borderSide: BorderSide(
                            color: Appcolors
                                .textBorderColor, // customize color here
                            width: 1.0,
                          ),
                        ),
                        focusedBorder: OutlineInputBorder(
                          ...
                          borderSide: BorderSide(
                            color: Appcolors
                                .textBorderColor, // change this if you want different focus color
                            width: 1.5,
                          ),
                        ),
                        filled: true,
            ...
            TabBar(
              ...
              indicator: const UnderlineTabIndicator(
                borderSide: BorderSide(
                  width: 1.5, // 👈 change this value to control thickness
                  color: Appcolors.appBlue,
                ),
              ),
              isScrollable: true,
  ...
  Widget buildNonValidatedAttendance(
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Container(
          decoration: BoxDecoration(
            border: Border.all(color: Appcolors.textBorderColor, width: 0.2),
            borderRadius: BorderRadius.circular(8.0),
                        ...
                        child: ElevatedButton(
                          ...
                          style: ElevatedButton.styleFrom(
                            ...
                            shape: RoundedRectangleBorder(
                              ...
                              side: BorderSide(
                                color: Colors
                                    .green, // Change to any color you want
                          ...
                          child: Text(
                            'Validate',
                            style: TextStyle(
                                fontSize: 18, color: Appcolors.greenSuccess),
                          ),
                        ),
                      ),
                    ),
                        ...
                        Visibility(
                          ...
                          child: InkWell(
                            onTap: () {
                              ...
                              _showValidateOvertimeAttendance(context, record);
                            },
                            child: Container(
                              height: 24,
                              width: 24,
