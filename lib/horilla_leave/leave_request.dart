...
''';
  ...
  Future<void> getAllLeaveRequest({bool isSearch = false}) async {
    final prefs = await SharedPreferences.getInstance();
    var token = prefs.getString("token");
    var typedServerUrl = prefs.getString("typed_url");
    if (currentPage != 0) {
      ...
      log(jsonEncode("uri======$uri"));
      log(jsonEncode("uri======$token"));
      if (response.statusCode == 200) {
        setState(() {
                        ...
                        onChanged: (wardSearchValue) {
                          ...
                          _debounce =
                            ...
                            setState(() {
                              ...
                              getAllLeaveRequest(isSearch: true);
                              getRequestedCount();
                              getApprovedCount();
                              getCancelledCount();
                              getRejectedCount();
            ...
            TabBar(
              ...
              indicator: const UnderlineTabIndicator(
                borderSide: BorderSide(
                    width: 1.5,
                    color:
                        Appcolors.appBlue), // 👈 reduce this for thinner line
              ),
                    ...
                    Container(
                      ...
                      child: Stack(
                        children: [
                          ...
                          if (record['employee_id']['employee_profile'] ==
                                  null ||
                              record['employee_id']['employee_profile'].isEmpty)
                            Positioned.fill(
                              child: Container(
                                decoration: BoxDecoration(
                                  shape: BoxShape.circle,
